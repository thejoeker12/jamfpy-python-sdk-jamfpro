...
class API:
    ...
    # @_check_closed
    def do(self, request: Request, timeout: int = 10, cert_path: str | None = None, verify_path: str | None = None) -> Response:
        ...
        response = self._session.send(prepped, timeout=timeout, cert=cert_path, verify=verify_path)
